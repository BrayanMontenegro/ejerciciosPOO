...
public class automovil {
   ...
   private String marca;
    ...
    public automovil(String marca, int modelo, double motor, String tipoCombustible, String tipoAutomovil, int numPuertas, int numAsientos, int velocidadMaxima, String color, int velocidadActual) {
        this.marca = marca;
        this.modelo = modelo;
        this.motor = motor;
